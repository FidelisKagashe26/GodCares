...
urlpatterns = [
    ...
    # Custom API endpoints (APIView based)
    path("user/dashboard/", views.UserDashboardAPIView.as_view(), name="user-dashboard"),
    path("user/journey-progress/", views.UserJourneyProgressAPIView.as_view(), name="user-journey-progress"),
    path("mission/heatmap-data/", views.MissionHeatmapDataAPIView.as_view(), name="mission-heatmap-data"),
    path("global/stats/", views.GlobalStatsAPIView.as_view(), name="global-stats"),
]
